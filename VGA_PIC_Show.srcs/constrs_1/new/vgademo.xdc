...
##set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { SDB }]; #IO_L4P_T0_34 Sch=JE1
##set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { SCLKA }]; #IO_L18N_T2_34 Sch=JE2
###set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_25_35 Sch=JE3
##set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { IIC_SDA }]; #IO_L19P_T3_35 Sch=JE4
##set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { MCLKA }]; #IO_L3N_T0_DQS_34 Sch=JE7
##set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets SCLKA]
##set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { FSA }]; #IO_L9N_T1_DQS_34 Sch=JE8
##set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L20P_T3_34 Sch=JE9
##set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { IIC_SCL }]; #IO_L7N_T1_34 Sch=JE10

####Pmod Header JA (XADC)
##set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { SDB }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
##set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { SCLKA }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P
###set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ja_p }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P
##set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { IIC_SDA }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P
##set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { MCLKA }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
##set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets SCLKA]
##set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { FSA }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N
##set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N
##set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { IIC_SCL }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N


###Pmod Header JB
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L15P_T2_DQS_34 Sch=JB1_p
...
##Pmod Header JD
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { SDB }]; #IO_L5P_T0_34 Sch=JD1_P
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { SCLKA }]; #IO_L5N_T0_34 Sch=JD1_N
##set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L6P_T0_34 Sch=JD2_P
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { IIC_SDA }]; #IO_L6N_T0_VREF_34 Sch=JD2_N
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { MCLKA }]; #IO_L11P_T1_SRCC_34 Sch=JD3_P
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { FSA }]; #IO_L11N_T1_SRCC_34 Sch=JD3_N
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L21P_T3_DQS_34 Sch=JD4_P
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { IIC_SCL }]; #IO_L21N_T3_DQS_34 Sch=JD4_N
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { MCLKA }]; #IO_L5P_T0_34 Sch=JD1_P
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { FSA }]; #IO_L5N_T0_34 Sch=JD1_N
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L6P_T0_34 Sch=JD2_P
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { IIC_SCL }]; #IO_L6N_T0_VREF_34 Sch=JD2_N
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { SDB }]; #IO_L11P_T1_SRCC_34 Sch=JD3_P
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { SCLKA }]; #IO_L11N_T1_SRCC_34 Sch=JD3_N
##set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { jd_p }]; #IO_L21P_T3_DQS_34 Sch=JD4_P
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { IIC_SDA }]; #IO_L21N_T3_DQS_34 Sch=JD4_N
...
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { SDB }]; #IO_L4P_T0_34 Sch=JE1
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { SCLKA }]; #IO_L18N_T2_34 Sch=JE2
##set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { je }]; #IO_25_35 Sch=JE3
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { IIC_SDA }]; #IO_L19P_T3_35 Sch=JE4
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { MCLKA }]; #IO_L3N_T0_DQS_34 Sch=JE7
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { FSA }]; #IO_L9N_T1_DQS_34 Sch=JE8
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L20P_T3_34 Sch=JE9
